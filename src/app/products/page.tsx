    ...
    <div className={styles.pageWrapper}>
      <div className={styles.heroSection}>
        <div className={styles.heroContent}>
          <h1 className={styles.heroTitle}>Investment Products</h1>
          <p className={styles.heroSubtitle}>
            Discover our range of investment options designed to help you achieve your financial goals, from conservative savings to growth-oriented portfolios.
          </p>
        </div>
      </div>
          ...
          {filteredProducts.map(product => (
            <div key={product.id} className={styles.card}>
              ...
              <div className={styles.cardFooter}>
                <Link 
                  href={`/products/${product.id}/productDetails`}
